  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        //   return warning.hasOwnProperty(params.value) ? warning[params.value] : "unknown Error"
        // },
        valueGetter: (params) =>{
          console.log(params.data.AlarmType)
          return warning.hasOwnProperty(params.data.AlarmType) ? warning[params.data.AlarmType] : "unknown Error"
        }
      },
      {
