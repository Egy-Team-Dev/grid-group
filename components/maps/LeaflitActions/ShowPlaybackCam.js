        ...
        if (loginToken !== null) {
          ...
          if (resLogin.status == 200 && resLogin?.data?.data !== null) {
            ...
            if (resDeviceStatus?.data?.data != null) {
              ...
              setCameraLink(
               `https://dashcam.saferoad.net/vss/apiPage/ReplayVideo.html?token=${loginToken}&deviceId=${SerialNumber}&chs=1_2_3_4&st=${startingDate}&et=${endingDate}&wnum=4&panel=1&${Speed??1}&buffer=3000`
              );
              setHasCamera(true);
