          ...
          <div>
            {!lodash.isEmpty(userInfos) && (
              <>
                <button
                  className="btn btn-outline-primary m-1"
                  onClick={() => handleForceLogout(params.data.ASPNetUserID)}
                >
                  <FontAwesomeIcon
                    className="pe-2"
                    icon={faSignOutAlt}
                ...
                <button
                  className="btn btn-outline-primary m-1"
                  onClick={() => {
                    setDeleteID(params?.data?.ProfileID);
                ...
                <button onClick={() => onDeactiveHandler(params?.data)} className="btn btn-outline-primary m-1">
                  {
